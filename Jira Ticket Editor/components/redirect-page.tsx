...
// Imports internal
import RedirectPageProps from "../interfaces/RedirectPageInterface";
 ...
 */
export function RedirectPage({countdown, message, reason, immediateRedirect, relativeURL}: {countdown: number, message: string, reason: string, immediateRedirect: string, relativeURL: string}) {
